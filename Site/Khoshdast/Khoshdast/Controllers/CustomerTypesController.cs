...
namespace Khoshdast.Controllers
{
    public class CustomerTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,IsActive,CreationDate,LastModifiedDate,IsDeleted,DeletionDate,Description")] CustomerType customerType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,IsActive,CreationDate,LastModifiedDate,IsDeleted,DeletionDate,Description")] CustomerType customerType)
        {
            if (ModelState.IsValid)
            {
				customerType.IsDeleted=false;
